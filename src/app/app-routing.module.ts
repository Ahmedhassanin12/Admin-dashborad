...
import { UpdateSellerComponent } from './Components/sellers/update-seller/update-seller/update-seller.component';
...
const routes: Routes = [
  {path: '', component: MainLayoutComponent, canActivate:[AdminAuthGuard], children:[
    ...
    {path: 'Sellers/:id', component: UpdateSellerComponent},
